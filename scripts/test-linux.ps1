...
# Prefix the project name so valid F# names beginning with '_' remain valid
# Docker volume names while retaining one stable cache volume per project.
$NugetVolume = 'nuget-__ProjectName__'
